...
from loss import EvalFunction, OverallLoss, ClassificationLoss 
...
class Trainer(EpochBasedTrainer):
    def __init__(self, cfg):
        ...
        self.classification_loss_func = ClassificationLoss(cfg)  # 添加分类损失函数
    ...
    def train_step(self, epoch, iteration, data_dict):
        ...
        loss_dict = self.loss_func(data_dict, output_dict)
         ...
         # 添加分类损失计算
        classification_loss = self.classification_loss_func(output_dict)
