...
_C.exp.output_dir = osp.join("rgbdv2", _C.exp.name)
...
# data
_C.data = edict()
_C.data.dataset_dir = "/ssd/czx/2D3DMATRsub/experiments/data/RGBDScenesV2"
...
_C.model.coarse_matching.similarity_threshold = 0.8
